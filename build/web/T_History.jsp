    ...
    <div class="container-fluid">
        ...
        <main>
            ...
            <section class="tm-welcome">
                <center>
                <h3 style='margin-top: 100px;'>View All Tourists History</h3>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <table>
                    <tr>
                        <th>Tourist Name</tH> <th>Search Name</tH> <th>Result Name</tH> <th>Search Date</tH>
                    </tr>
                <%try{
                   ...
                   while(r.next()){
                       %>
                       <tR>
                           <td><%=r.getString("tourist")%></td>
                           <td><%=r.getString("search_name")%></td>
                           <td><%=r.getString("result_name")%></td>
                           <td><%=r.getString("search_date")%></td>
                       </tR>
